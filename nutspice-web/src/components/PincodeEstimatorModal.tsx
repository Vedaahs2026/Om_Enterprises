        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-brand/5 border border-brand/5 focus:border-brand-accent/50 rounded-xl py-3 px-4 text-sm font-bold text-brand focus:outline-none focus:ring-2 focus:ring-brand-accent/20 transition-all"
          ...
          <button
            ...
            className="w-full bg-brand text-white py-3 rounded-xl font-bold tracking-widest uppercase text-xs hover:bg-brand-hover transition-all shadow-md active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
            Calculate
          </button>
        </form>
