...
async function seed() {
  ...
  try {
    ...
    const navItems = await db.insert(navigationMenu).values([
      ...
      { label: "LED Lighting", href: "/category/lighting", order: 5, isActive: true },
      { label: "Fans", href: "/category/fans", order: 6, isActive: true },
      { label: "Conduits & Pipes", href: "/category/conduits", order: 7, isActive: true },
      { label: "Fittings & Accessories", href: "/category/fittings", order: 8, isActive: true },
      { label: "Industrial Electrical", href: "/category/industrial", order: 9, isActive: true },
      { label: "Home Electrical", href: "/category/home-products", order: 10, isActive: true },
    ]).returning();
