...
async function main() {
  console.log("Starting product and database catalog sync for 8 categories...");
  ...
  try {
    ...
    // 2. Navigation Menu (4 active, 4 inactive for the 8 categories)
    ...
    const productList = await db.insert(products).values([
      ...
      },
      {
        ...
        description: "Classic mechanical chime doorbell with a clean corporate design and smooth musical tone.",
        basePrice: 240,
        salePrice: 180,
    ...
    // 5. Seeding Page Sections (Dynamic grid sections on homepage)
    ...
    console.log("Sync Complete! 18 products seeded successfully across 8 categories.");
